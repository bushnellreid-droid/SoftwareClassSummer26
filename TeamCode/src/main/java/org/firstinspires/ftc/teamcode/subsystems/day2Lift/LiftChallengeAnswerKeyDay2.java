...
@Config
public class LiftChallengeAnswerKeyDay2 {
    ...
    public LiftChallengeAnswerKeyDay2(HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    public void update() {
        ...
        double totalPower = gravityFeedforward + frictionFeedforward + pidPower;
