...
public class ShooterTemplate {
    public static double kV = 0.00043429, kS = 0.13074;
    ...
    public ShooterTemplate(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        shooterMotor = hardwareMap.get(DcMotorEx.class, "shooterMotor2"); // the string name will vary based on your hardware map config
    ...
    private double calculatePower(double currentVelocity, double targetVelocity) {
        ...
        double feedback = pid.calculate(currentVelocity, targetVelocity);
